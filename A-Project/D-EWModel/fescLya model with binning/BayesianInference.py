...
class BayesInf:
        ...
        def DetectionTypeReal(self):
            ...
            for i in range(0,len(self.fesc_obs)):
                if self.typesCat[i]=="LAE" and np.isnan(self.dfesc[i])==True and self.fesc_obs[i]>1:
                    self.types.append("LyaHa")
                elif self.typesCat[i]=="LAE" and np.isnan(self.dfesc[i])==False:
                    self.types.append("LyaHa")
                ...
                print(self.typesCat[i],self.dfesc[i],self.types[i],self.fesc_obs[i])

...
libname_dir = "/Users/gonzalo/Desktop/Code/Gonzalo_Binospec/code/data/large_files/starModels/"   #THIS MAY NEED TO BE CHANGED
...
class FluxCalBino(object):
    ...
    def flux_calibration(self, data_flux, data_wave, z=0.):  
        ...
        print("Flux Calibration: ",np.nanmedian(calibration))
        return calibration

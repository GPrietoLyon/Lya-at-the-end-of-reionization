...
# =====================================================================
molecfit_path = "/opt/local/share/reflex/workflows/molecfit-4.2/"
telluric_dir = "/Users/gonzalo/Desktop/Code/Gonzalo_Binospec/code/Bino_analysis/telluric_corrections/"
...
spec2D_all = sorted(bt.insensitive_glob(datadir+'/*/obj_clean*abs_slits_lin.fits'))
...
def run_molecfit(ss):
    ...
    try:
    # Run molecfit
        cmd_molecfit = 'esoreflex molecfit -n %s' % molecfit_par_filename

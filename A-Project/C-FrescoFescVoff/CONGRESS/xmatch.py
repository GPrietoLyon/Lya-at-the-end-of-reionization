...
def Filter_separation(dist2d,maxdist=0.5/3600):
    """Filter the output of xmatch() for matches within a maximum angular distance.

    Parameters
    ----------
    maxdist2d : float
        Maximum angular distance in units of 'units' to be considered a match.

    Returns
    -------
    A function that can be used as a filter function for the output of xmatch().

    """

    sep_mask = (dist2d.value <= maxdist)
